...
- **如果本项目有任何侵权行为， 请提Issue或发送邮件至[zhenglinjame@163.com](zhenglinjame@163.com)，我们将在第一时间进行回复和处理。**

如果你认为本仓库的一些文件侵犯了您的权益，请 [向我们发送邮件](zhenglinjame@163.com) 。我们将会从仓库中彻底清除这些文件。

## 友情链接

[南京审计大学金融学院CFA编辑部](https://github.com/jxrjxzl/nausharefile)
